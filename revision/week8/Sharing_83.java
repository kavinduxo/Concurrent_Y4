/** 
 *******************************************************
 ** File:   	Sharing_83.java [WAS: Sharing_82.java]
 ** Author:	P. Howells
...
/**
  ...
  Answer: Shows the results of isAlive true (RUNNABLE or non-runnable states) 
          or false ( NEW or terminated).
**/
...
class Sharing_83
{
   ...
   public static void main ( String args[] ) 
   {
      ...
      Reader_82 reader1 = new Reader_82( "Reader-1", X, Y, 5 ) ; 

      Reader_82 reader2 = new Reader_82( "Reader-2", X, Y, 5 ) ; 

      Writer_82 writer1 = new Writer_82( "Writer-1", X, Y, 5, 0 ) ; 

      Writer_82 writer2 = new Writer_82( "Writer-2", X, Y, 5, 100 ) ; 
